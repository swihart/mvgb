#' Multivariate Laplace Distribution Probabilities (via exponential variates)
#'
#'
...
#'   2) The QRVSN method on exponential variates, not chi/sqrt(nu).
#'
...
#' @param delta Not implemented yet.  Delta for MVTDST is something different than mu for laplace
#'
#' @references
#'
...
#'## [1] 0.1547664
#' @export
pmvlaplace <- function(x, n, lower, upper, infin, corr, corrF, delta) {
